            ...
            for (int j = 0; j < 6; j++) {
                if (colourOfCell[i][j] == 0) {
                    ...
                    if (isWin(colourOfCell, player)) {
                        move = new Move(i, j, false, true, true, true);
                        colourOfCell[i][j] = 0;
                        return true;
                    } else {
...
//    private boolean three_balls_line(int[][] colourOfCell, int player) {
//
//        for (int i = 0; i < 6; i++) {
//            int countOfTheSame = 0;
//            int countOfEmpty = 0;
//            for (int j = 0; j < 6; j++) {
//                if (player == colourOfCell[i][j]) countOfTheSame++;
//                if (colourOfCell[i][j] == 0) countOfEmpty++;
//            }
//            if (countOfTheSame == 3 && countOfEmpty == 3) return true;
//        }
//
//        for (int i = 0; i < 6; i++) {
//            int countOfTheSame = 0;
...
//            for (int j = 0; j < 6; j++) {
//                if (player == colourOfCell[j][i]) countOfTheSame++;
//                if (colourOfCell[j][i] == 0) countOfEmpty++;
//            }
//            if (countOfTheSame == 3 && countOfEmpty == 3) return true;
//        }
//
...
//        for (int i = 0; i < 6; i++) {
//            if (player == colourOfCell[i][i]) countOfTheSame++;
//            if (colourOfCell[i][i] == 0) countOfEmpty++;
//            if (countOfTheSame == 3 && countOfEmpty == 3) return true;
//        }
//
//        for (int i = 0; i < 6; i++) {
//            if (player == colourOfCell[i][5 - i]) countOfTheSame++;
//            if (colourOfCell[i][5 - i] == 0) countOfEmpty++;
//            if (countOfTheSame == 3 && countOfEmpty == 3) return true;
//        }
//        return false;
//    }
...
//
//
// private boolean opponent_victory_after_4_moves(int[][] colourOfCell, Move move_player, Move move_opponent, int player, int opponent) {
//        int kordX1, kordY1;
//        if (move_player.get_Top()) kordX1 = 0;
//        else kordX1 = 3;
//        if (move_player.get_Left()) kordY1 = 0;
//        else kordY1 = 3;
//        colourOfCell[move_player.get_KordX()][move_player.get_KordY()] = player;
//        rotation_field(colourOfCell, kordX1, kordY1, move_player.get_Clockwise());
//
//        int kordX2, kordY2;
//        if (move_opponent.get_Top()) kordX2 = 0;
//        else kordX2 = 3;
//        if (move_opponent.get_Left()) kordY2 = 0;
//        else kordY2 = 3;
//        colourOfCell[move_opponent.get_KordX()][move_opponent.get_KordY()] = opponent;
//        rotation_field(colourOfCell, kordX2, kordY2, move_opponent.get_Clockwise());
//
//        for (int i = 0; i < 6; i++)
//            for (int j = 0; j < 6; j++) {
//                if (colourOfCell[i][j] == 0) {
//                    m = new Move(i, j, true, true, true, true);
//                    if (!opponent_victory_after_the_move(colourOfCell, m, player, opponent)) {
//                        rotation_field(colourOfCell, kordX2, kordY2, !move_opponent.get_Clockwise());
//                        colourOfCell[move_opponent.get_KordX()][move_opponent.get_KordY()] = 0;
//                        rotation_field(colourOfCell, kordX1, kordY1, !move_player.get_Clockwise());
//                        colourOfCell[move_player.get_KordX()][move_player.get_KordY()] = 0;
//                        return false;
//                    }
//                    m = new Move(i, j, true, false, true, true);
//                    if (!opponent_victory_after_the_move(colourOfCell, m, player, opponent)) {
